...
/* enumerations from "gtksourceannotation.h" */

GTK_SOURCE_ENUM_EXTERN
GType gtk_source_annotation_style_get_type (void);
#define GTK_SOURCE_TYPE_ANNOTATION_STYLE (gtk_source_annotation_style_get_type())
